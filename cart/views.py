...
def addToCart(request, listing_id):
    this_listing = ProductListing.objects.get(id = listing_id)

    cart_item, created_at = CartItem.objects.get_or_create(product_listing = this_listing, user = request.user)
